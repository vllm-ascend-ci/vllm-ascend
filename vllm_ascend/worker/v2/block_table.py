...
class AscendBlockTables(BlockTables):
    ...
    def compute_slot_mappings(
        ...
        if vllm_version_is("0.27.1"):
            # Release lane keeps the kernel block sizes in block_sizes_tensor.
            group_block_sizes = self.block_sizes_tensor
        else:
            # Newer vLLM separates KV block sizes (block_sizes_tensor) from
            # kernel block sizes; the kernel below indexes kernel blocks.
            group_block_sizes = self.kernel_block_sizes_tensor
