...
def _fix_incompatible_config(vllm_config: VllmConfig) -> None:
    ...
    if vllm_config.attention_config:
        ...
        if vllm_version_is("0.27.1"):
            # Removed from AttentionConfig upstream after 0.27.1; still present
            # (and NVIDIA-specific) on the release lane.
            force_false_flags.insert(0, "use_prefill_decode_attention")
